...
public record SaveDisciplineRequest(
                ...
                @NotBlank(message = "O código é obrigatório") @Schema(title = "Cod", example = "COM10394") String cod,

                @NotBlank(message = "A carga horária é obrigatória") @Schema(title = "Ch", example = "60") String ch,
